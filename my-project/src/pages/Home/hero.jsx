  ...
  return (
    <section id="home" className="max-w-6xl mx-auto py-16 px-6 grid md:grid-cols-2 gap-8 items-center">
      <div>
        ...
        <button
          onClick={navi}
          className="mt-6 bg-[#1E3A8A] text-white px-6 py-3 rounded text-lg transition-all duration-300 ease-in-out hover:bg-[#2563EB] hover:shadow-md"
        >
          Get Started
        </button>
      </div>
